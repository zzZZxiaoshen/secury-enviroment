...
<head>
    ...
    <link href="${pageContext.request.contextPath}/static/css/plugins/flexible/flexible.css" type="text/css"
          rel="stylesheet"/>
    <link href="${pageContext.request.contextPath}/static/css/plugins/heightchats/highcharts.css" type="text/css"
          rel="stylesheet"/>
    <link href="${pageContext.request.contextPath}/static/css/business/phone/data-list.css" type="text/css"
          rel="stylesheet"/>
