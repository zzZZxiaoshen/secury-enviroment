package com.marsfood.domain.dataSource1order;
 ...
 * @date 2018/11/22
 */
public class DataSouce1OrderDo {
    private String id;
    ...
    private Integer txccy;
    private Double serviceFee;
    private Double logisticsFee;
    private Double cheapFee;
    private Integer cheapId;
    ...
    private List<DataSouce1OrderDetailDo> orderDetailDos;
    ...
    public Integer getTxccy() {
        return txccy;
    }

    public void setTxccy(Integer txccy) {
        this.txccy = txccy;
    }
    ...
    public Double getCheapFee() {
        return cheapFee;
    }

    public void setCheapFee(Double cheapFee) {
        this.cheapFee = cheapFee;
    }

    public Integer getCheapId() {
        return cheapId;
    }

    public void setCheapId(Integer cheapId) {
    ...
    public List<DataSouce1OrderDetailDo> getOrderDetailDos() {
        return orderDetailDos;
    }

    public void setOrderDetailDos(List<DataSouce1OrderDetailDo> orderDetailDos) {
